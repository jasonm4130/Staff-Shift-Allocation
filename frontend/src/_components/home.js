    ...
    render() {
        return (
            <div className="m-t-75">
                ...
                <p>The Application has been built out with MongoDB as a NoSQL database with an mongoose / graphQL backgend. This is my second project in NodeJs as a backend and my first with GraphQl as an API.</p>
                ...
                <p>Ideally this app would also be behind some auth to allow for different levels of functionality, with managers being able to access and edit all functions, with lower acces level staff members only able to view and edit their own data.</p>
                ...
                <p>It would also be benificial to add in to the application the ability for managers to display a nicely formatted runsheet of the weekend / week. To get a good overview of everyone rostered on.</p>
            </div>
        )
    }
}
